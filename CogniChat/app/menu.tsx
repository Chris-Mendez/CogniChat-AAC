    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.textSection}>
        ...
        <Text style={styles.subtitle}>
          Select the tool that best fits your current needs. You can switch
      ...
      <View style={styles.cardRow}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            Use the communication board to express your thoughts, feelings, and
            needs with text-to-speech support.
          </Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            Practice cognitive and language skills through interactive exercises
