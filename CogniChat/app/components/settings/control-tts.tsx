...
import { resolveValidTTSVoice } from "@/app/utils/resolve-valid-tts-voice";
import { PICKER_NO_SELECTION } from "@/app/constants/picker-no-selection";

interface ControlTTSProps {}

export const ControlTTS: React.FC<
  ControlTTSProps
> = ({}: ControlTTSProps): JSX.Element => {
